...
class InternalState:
    def __init__(self, model, embedding_model):
        ...
        self._generate_summarize_transcript_prompt = Config.SUMMARIZE_TRANSCRIPT_PROMPT_FUNC[self._model.model_name]
        self._generate_summarize_summaries_prompt = Config.SUMMARIZE_SUMMARIES_PROMPT_FUNC[self.model.model_name]
    ...
    @property
    def generate_summarize_transcript_prompt(self):
        return self._generate_summarize_transcript_prompt

    @property
    def generate_summarize_summaries_prompt(self):
        return self._generate_summarize_summaries_prompt
